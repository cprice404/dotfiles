...
alias puppetenv="export RUBYLIB=\"$PUPPETSERVER_SOURCE_DIR/lib:$FACTER_SOURCE_DIR/lib:$PUPPET_SOURCE_DIR/lib\"; export PATH=\$PATH:$PUPPET_SOURCE_DIR/bin:$FACTER_SOURCE_DIR/bin"
